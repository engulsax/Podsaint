...
<html>
  ...
  <head>
  <body>
    <svg xmlns="http://www.w3.org/2000/svg" style="width:0;height:0;visibility:hidden;"><defs><g id="cleanup_with_currentColor-shape"><rect fill="currentColor" x="50" y="50" width="50" height="50"/></g><linearGradient id="element-b" gradientUnits="userSpaceOnUse" x1="485.463" y1="-496.876" x2="500.38" y2="-492.976" gradientTransform="matrix(.707 .707 -.707 .707 -679.147 21.663)"/> <linearGradient id="usingdef-grad1" x1="0%" y1="0%" x2="100%" y2="0%"> <stop offset="0%" style="stop-color:rgb(255,255,0);stop-opacity:1"/> <stop offset="100%" style="stop-color:rgb(255,0,0);stop-opacity:1"/> </linearGradient> </defs><symbol viewBox="0 0 24 24" id="bounding_box"><title>bounding_box</title> <path id="bounding_box-remove-me" fill="none" stroke="none" d="M0 0h24v24H0z"/> <path class="foo" d="M17 14h4v4h-4z"/> <path class="bar" d="M27 24h4v4h-4z"/> </symbol><symbol id="cleanup_with_currentColor"><title>cleanup_with_currentColor</title></symbol><symbol id="cleanup"><title>cleanup</title>  <metadata id="cleanup-metadata3320"> <rdf:RDF> <cc:Work rdf:about=""> <dc:format>image/svg+xml</dc:format> <dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage"/> <dc:title/> </cc:Work> </rdf:RDF> </metadata> <g transform="matrix(-1,0,0,-1,64.084221,73.450016)" id="cleanup-layer3" style="fill:#000000;display:inline"> <path d="M 32.023548,13.911903 64.114266,44.069169 61.158286,47.02306 32.023548,19.819685 2.9238456,47.538113 -0.03004543,44.584221 z" id="cleanup-path3317" style="fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none"/> </g> <g transform="matrix(-1,0,0,-1,64.047096,55.009338)" id="cleanup-g5637" style="fill:#000000;display:inline"> <path d="M 32.023548,13.911903 64.114266,44.069169 61.158286,47.02306 32.023548,19.819685 2.9238456,47.538113 -0.03004543,44.584221 z" id="cleanup-path5639" style="fill:#000000;fill-opacity:1;fill-rule:nonzero;stroke:none"/> </g> </symbol><symbol viewBox="0 0 100 100" id="codepen"><title>Codepen Icon</title><desc>This is the offical Codepen icon</desc> <g>   <path d="M50,0C22.385,0,0,22.385,0,50c0,27.615,22.385,50,50,50c27.614,0,50-22.385,50-50C100,22.385,77.615,0,50,0z M50,91.789
		...
		l9.298,6.219L52.657,73.294z M75.602,54.447L68.955,50l6.647-4.446V54.447z"/> </g> </symbol><symbol viewBox="0 0 100 100" id="dribbble"><title>dribbble</title> <path fill="#231F20" d="M52.988,50.438c0.556-0.181,1.116-0.347,1.68-0.508c-1.069-2.426-2.237-4.854-3.46-7.248
	C29.881,49.066,9.185,48.8,7.314,48.76c-0.012,0.436-0.022,0.871-0.022,1.308c0,10.969,4.161,20.981,10.981,28.555
	C19.242,76.965,30.96,57.558,52.988,50.438z M47.677,36.116c-7.075-12.579-14.706-23.154-15.833-24.7
	c-11.948,5.636-20.88,16.651-23.65,29.902C10.105,41.345,27.701,41.421,47.677,36.116z M78.312,18.12
	c-7.543-6.691-17.457-10.763-28.31-10.763c-3.443,0-6.797,0.415-10.006,1.19c1.179,1.58,8.935,12.142,15.933,25.001
	C71.116,27.856,77.543,19.214,78.312,18.12z M62.044,46.084c0.314,0.736,0.622,1.472,0.921,2.201
	c14.209-1.785,28.327,1.08,29.737,1.375c-0.094-10.081-3.696-19.337-9.646-26.603c-0.899,1.218-8.055,10.396-23.846,16.84
	C60.206,41.931,61.158,44,62.044,46.084z M57.291,57.087c-24.087,8.396-32.735,25.099-33.504,26.672
	c7.243,5.645,16.342,9.014,26.215,9.014c5.916,0,11.556-1.21,16.681-3.394c-0.635-3.747-3.115-16.807-9.107-32.388
	C57.479,57.024,57.387,57.054,57.291,57.087z M50.002,100C22.43,100,0,77.569,0,50.001C0,22.432,22.43,0,50.002,0
	C77.573,0,100,22.432,100,50.001C100,77.569,77.573,100,50.002,100z M65.564,55.02c5.587,15.349,7.862,27.852,8.3,30.448
	c9.578-6.479,16.402-16.741,18.306-28.624C90.707,56.384,78.952,52.877,65.564,55.02z"/> </symbol><symbol viewBox="0 0 100 100" id="element"><title>element</title> <path fill="url(#element-b)" d="M20.426 26.117l3.631-1.997c.736-.407.736-1.068 0-1.473l-3.645-2.004-2.73 2.73 2.744 2.744z"/>  </symbol><symbol viewBox="0 0 100 100" id="email"><title>email</title> <path d="M44.933,98.093C19.882,92.443,3.579,72.894,6.295,42.843C8.963,13.331,32.181-0.745,54.983,0.03
	...
	c-3.004,0.09-5.087,1.144-7.031,2.97C43.801,36.147,42.614,38.669,42.286,39.479z"/> </symbol><symbol viewBox="0 0 100 100" id="facebook"><title>facebook</title> <g> <g> <path d="M94.48,0H5.519C2.471,0,0,2.471,0,5.52v88.96c0,3.049,2.47,5.521,5.519,5.521h63.479L53.411,100V61.273h-13.03V46.181
			...
			C100,2.471,97.529,0,94.48,0z"/> </g> </g> </symbol><symbol viewBox="0 0 100 100" id="github"><title>github</title> <g> <path d="M50.049,0.3c14.18,0.332,25.969,5.307,35.366,14.923S99.675,36.9,100,51.409c-0.195,11.445-3.415,21.494-9.658,30.146
		...
		C0.325,36.602,5.187,24.54,14.585,14.923C23.984,5.308,35.772,0.333,49.951,0L50.049,0.3z"/> </g> </symbol><symbol viewBox="0 0 100 100" id="googleplus"><title>googleplus</title> <g> <path d="M44.438,59.102c-0.699-0.091-1.137-0.091-2.012-0.091c-0.789,0-5.518,0.177-9.193,1.441
		c-1.927,0.714-7.527,2.868-7.527,9.237c0,6.375,6.041,10.957,15.408,10.957c8.406,0,12.873-4.139,12.873-9.694
		C53.984,66.364,51.096,63.945,44.438,59.102z"/> <path d="M49.167,35.495c0-6.463-3.768-16.514-11.029-16.514c-2.283,0-4.729,1.168-6.133,2.965c-1.49,1.887-1.923,4.301-1.923,6.643
		c0,6.01,3.412,15.971,10.944,15.971c2.188,0,4.543-1.07,5.953-2.509C48.991,39.979,49.167,37.112,49.167,35.495z"/> <path d="M96.879,0H3.121C1.396,0,0,1.428,0,3.19v93.615c0,1.766,1.396,3.193,3.121,3.193h93.758c1.727,0,3.121-1.43,3.121-3.193
		...
		h-8.758v-4.48h8.758v-8.975h4.334v8.975h8.801V48.903z"/> </g> </symbol><symbol viewBox="0 0 100 100" id="itunes"><title>itunes</title> <path d="M34.654,21.67v51.301c-3.423-1.393-7.51-1.871-11.754-1.022c-9.634,1.928-16.208,9.67-14.68,17.297
	...
	C83.035,86.802,51.447,59.185,51.447,59.185z"/> </symbol><symbol id="preserve_attribute"><title>preserve_attribute</title> <rect x="400" y="100" width="400" height="200" stroke-width="10" fill="blue" stroke="red" imafake="idunno"/> </symbol><symbol viewBox="0 0 100 100" id="rss"><title>rss</title> <g> <path d="M7.336,62.163c-0.388-0.075-0.783-0.112-1.171-0.112c-1.42,0-2.81,0.491-3.923,1.409C0.822,64.632,0,66.375,0,68.216
		...
		c0.22,3.235,2.907,5.75,6.151,5.75h3.091c1.706,0,3.335-0.706,4.5-1.95C99.498,96.805,100.098,95.135,99.986,93.431z"/> </g> </symbol><symbol viewBox="0 0 100 100" id="scissors"><title>scissors</title>  <g id="scissors-Your_Icon"> <path d="M88.781,68.58c-4.819-6.068-13.189-8.268-20.355-6.131l-7.984-10.054L86.98,13.793c2.142-3.177,1.713-7.589-0.952-9.786
		...
		c2.603,0,5.045,1.177,6.685,3.251c1.449,1.815,2.114,4.103,1.87,6.431C82.391,83.961,81.276,86.056,79.488,87.521z"/> </g> </symbol><symbol viewBox="0 0 100 100" id="twitter"><title>twitter</title> <path id="twitter-shape-twitter" d="M100.001,17.942c-3.681,1.688-7.633,2.826-11.783,3.339
	...
	c0-0.92-0.02-1.834-0.059-2.743C93.771,25.929,97.251,22.195,100.001,17.942L100.001,17.942z"/> </symbol><symbol viewBox="0 0 100 100" id="usingdef"><title>usingdef</title>  <ellipse cx="50%" cy="50%" rx="50%" ry="25%" fill="url(#usingdef-grad1)" id="usingdef-myellipse"/> </symbol><symbol viewBox="0 0 100 100" id="youtube"><title>youtube</title> <g> <path d="M98.77,27.492c-1.225-5.064-5.576-8.799-10.811-9.354C75.561,16.818,63.01,15.993,50.514,16
		...
		c0-2.548,1.917-3.644,4.262-2.429l23.572,12.188C69.896,49.008,69.896,50.992,67.549,52.203"/> </g> </symbol><symbol viewBox="0 0 40 40" id="anim"><title>anim</title><desc>description element contents</desc>  <path opacity="0.2" fill="#000" d="M20.201,5.169c-8.254,0-14.946,6.692-14.946,14.946c0,8.255,6.692,14.946,14.946,14.946 s14.946-6.691,14.946-14.946C35.146,11.861,28.455,5.169,20.201,5.169z M20.201,31.749c-6.425,0-11.634-5.208-11.634-11.634 c0-6.425,5.209-11.634,11.634-11.634c6.425,0,11.633,5.209,11.633,11.634C31.834,26.541,26.626,31.749,20.201,31.749z"/> <path fill="#000" d="M26.013,10.047l1.654-2.866c-2.198-1.272-4.743-2.012-7.466-2.012h0v3.312h0 C22.32,8.481,24.301,9.057,26.013,10.047z"> <animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0 20 20" to="360 20 20" dur="1s" repeatCount="indefinite"/> </path> </symbol></svg>

        <svg>
          <use xlink:href="#bounding_box" />
        </svg>
        <svg>
          <use xlink:href="#cleanup_with_currentColor" />
        </svg>
        <svg>
          <use xlink:href="#cleanup" />
        </svg>
        <svg>
